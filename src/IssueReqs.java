...
public class IssueReqs extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "STUDENT NAME", "BOOK ID", "BOOK NAME", "FOR DAYS"
            }
        ));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try
       {
           ...
           PreparedStatement ps = con.prepareStatement("select *from issuereq");
           ...
           while(rs.next())
           {
               Object o[] ={rs.getString("StudentName"),rs.getString("BookID"),rs.getString("BookName"),rs.getInt("ForDays")};
               tm.addRow(o);
           }
